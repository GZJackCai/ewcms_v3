      ...
      <div id="tb" style="padding:5px;height:auto;">
        ...
        <div style="padding-left:5px;">
          <form id="queryform"  style="padding: 0;margin: 0;">
            ...
            <a href="javascript:void(0);" id="tb-clear" class="easyui-linkbutton" data-options="iconCls:'icon-clear'" onclick="javascript:$('#registerDate').datebox('setValue','');document.forms[0].reset();">清除</a>
          </form>
        </div>
      </div>	
	</div>
