			    ...
			    columns:[[  
			            {field:'frequency',title:'名称',width:120,
			            	formatter : function(val, rec){
			            		if (rec.accessFrequencyPk.frequency>=30){
			            			return ">=30次";
			            		}else{
			            			return rec.accessFrequencyPk.frequency + "次";	
			            		}
			            	}	
			            }, 
			            {field:'frequencyCount',title:'频率数量',width:100},
			            {field:'rate',title:'比例',width:100},  
			            {field:'trend',title:'时间趋势',width:70,
			            	formatter : function(val, rec){	
			            		return '<a href="javascript:void(0)" style="text-decoration: none" onclick="openTrend(\'' + rec.accessFrequencyPk.frequency + '\')">时间趋势</a>';
			            	}
			            }
			    ]]  
			});
