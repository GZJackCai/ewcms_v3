	...
	<script type="text/javascript">
		$(function() {
			...
			$('#tt').datagrid({
				...
				nowrap : true,
				striped : true,
				url : '${ctx}/visit/clickrate/sourceform/table?startDate=' + $('#startDate').datebox('getValue') + '&endDate=' + $('#endDate').datebox('getValue'),
				columns:[[  
				    {field:'date',title:'日期',width:120,
				    	formatter : function(val, rec){
				    		if (rec.sourceFormPk == null) return '总计';
				    		return rec.sourceFormPk.visitDate;
				    	}  
				    }, 
		...
		function showChart(){
			...
			$.post('${ctx}/visit/clickrate/sourceform/report', parameter, function(result) {
