	...
	<script type="text/javascript">
		$(function() {
			...
			$('#tt').datagrid({
				...
				nowrap : true,
				striped : true,
				url : '${ctx}/visit/clickrate/website/table?startDate=' + $('#startDate').datebox('getValue') + '&endDate=' + $('#endDate').datebox('getValue'),
				columns:[[  
		            {field:'webSiteName',title:'名称',width:120,
		            	formatter : function(val, rec){
		            		return rec.webSitePk.webSiteName;
		            	}	
		            }, 
			        ...
			        {field:'trend',title:'时间趋势',width:70,
			         	formatter : function(val, rec){	
		            		return '<a href="javascript:void(0)" style="text-decoration: none" onclick="openTrend(\'' + rec.webSitePk.webSiteName + '\')">时间趋势</a>';
			           	}
			        }
			    ]]  
			});
		...
		function showChart(){
			...
			$.post('${ctx}/visit/clickrate/website/report', parameter, function(result) {
		...
		function openTrend(value){
			var url = '${ctx}/visit/clickrate/website/trend/index?webSiteName=' + value + '&startDate=' + $('#startDate').datebox('getValue') + '&endDate=' + $('#endDate').datebox('getValue');
