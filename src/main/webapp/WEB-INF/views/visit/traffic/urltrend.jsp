  ...
  <body class="easyui-layout">
    <div region="north" style="height:310px" border="false">
	  <table width="100%" border="0" cellspacing="2" cellpadding="0" style="border-collapse: separate; border-spacing: 2px;">
		<tr>
		  <td>
			从 <input type="text" id="startDate" name="startDate" class="easyui-datebox" style="width:120px" editable="false" value="${startDate}" required="required"/> 至 <input type="text" id="endDate" name="endDate" class="easyui-datebox" style="width:120px" editable="false" value="${endDate}" required="required"/> <a class="easyui-linkbutton" href="javascript:void(0)" onclick="showChart($('#startDate').datebox('getValue'), $('#endDate').datebox('getValue'));return false;">查看</a>
			  ...
			  <tr>
				<td style="padding:0px;">
				  <div style="height: 100%;margin:0px;">
					<div id="divChart" style="width:640px;height:260px;background-color:white">
					</div>
				  </div>
				</td>
			  </tr>
	...
	<script type="text/javascript">
		function showChart(startDate, endDate){
			...
			$.post('${ctx}/visit/traffic/url/trend/report', parameter, function(result) {
