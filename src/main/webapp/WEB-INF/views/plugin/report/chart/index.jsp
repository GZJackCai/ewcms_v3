...
<html>
  ...
  <body class="easyui-layout">
	...
	<script type="text/javascript" src="${ctx}/static/views/plugin/report/chart/index.js"></script>
	<script type="text/javascript">
		var _chartIndex = new ChartIndex('#tt');
		$(function(){
			_chartIndex.init({
				queryUrl : '${ctx}/plugin/report/chart/query',
				editUrl : '${ctx}/plugin/report/chart/edit',
				deleteUrl : '${ctx}/plugin/report/chart/delete',
				parameterUrl : '${ctx}/plugin/report/parameter/index',
				schedulingUrl : '${ctx}/scheduling/job/report/index',
				helpUrl : '${ctx}/plugin/report/chart/help'
			});
		});
	</script>
  </body>
