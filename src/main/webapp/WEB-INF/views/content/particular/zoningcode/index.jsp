...
<html>
  ...
  <body class="easyui-layout">
      ...
      <div id="tb" style="padding:5px;height:auto;">
        ...
        <div  style="padding-left:5px;">
          <form id="queryform"  style="padding: 0;margin: 0;">
                     行政区划编码：<input type="text" name="LIKE_code" style="width:120px;"/>&nbsp;
                     行政区划名称：<input type="text" name="LIKE_name" style="width:120px;"/>&nbsp;
	...
	<script type="text/javascript" src="${ctx}/static/views/content/particular/zoningcode/index.js"></script>
	<script type="text/javascript">
		var _zoningCodeIndex = new ZoningCodeIndex('#tt');
		$(function(){
			_zoningCodeIndex.init({
		       	queryUrl : '${ctx}/content/particular/zoningcode/query',
		       	editUrl : '${ctx}/content/particular/zoningcode/edit',
		       	deleteUrl : '${ctx}/content/particular/zoningcode/delete'
			});
		});
	</script>
  </body>
