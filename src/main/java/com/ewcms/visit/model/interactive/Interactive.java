package com.ewcms.visit.model.interactive;
...
public class Interactive implements Serializable{
	...
	private static final long serialVersionUID = 3688541134035981637L;
	 ...
	 * @param jywtgCount
	 */
	public Interactive(String organName, Long zxblCount, Long zxhfCount, Long zxtgCount, Long zxwtgCount, Long tsblCount, Long tshfCount, Long tstgCount,
	 ...
	 * @param wtgCount
	 */
	public Interactive(String organName, Long tgCount, Long wtgCount) {
		super();
		this.organName = organName;
