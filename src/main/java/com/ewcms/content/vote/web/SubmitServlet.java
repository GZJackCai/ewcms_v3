    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    	...
    	try{
	    	...
	    	if (voteEnd){
		    	...
		    	Questionnaire questionnaire = questionnaireService.findQuestionnaire(new Long(questionnaireId));
		        ...
		        if (captcha) {
		        	PersonService personService = (PersonService) wac.getBean("personService");
				   	Boolean isEntity = personService.findPersonIsEntity(new Long(questionnaireId), ipAddr);
				   	if (!isEntity){
