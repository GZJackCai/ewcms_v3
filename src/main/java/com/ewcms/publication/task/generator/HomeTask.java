...
public class HomeTask extends TemplateTaskBase{
	...
	public HomeTask(Site site, Channel channel, Configuration cfg,  String tempRoot, String templatePath, 
		...
		this(null, false, site, channel, cfg, tempRoot, templatePath, resourcePublishDao, templateSourcePublishDao);
	}
	
	public HomeTask(String parentId, Site site, Channel channel, Configuration cfg,  String tempRoot, String templatePath, 
			ResourcePublishDaoable resourcePublishDao, TemplateSourcePublishDaoable templateSourcePublishDao) {
		
		this(parentId, true, site, channel, cfg, tempRoot, templatePath, resourcePublishDao, templateSourcePublishDao);
	}
