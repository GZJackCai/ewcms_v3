...
public class ResourceTask extends ResourceSiteTask{
	...
	public ResourceTask(Site site, List<Long> ids, ResourcePublishDaoable resourcePublishDao) {
		super(site, true, resourcePublishDao);
		this.ids = ids;
	}
	...
	protected int totalCount() {
		resources = resourcePublishDao.findPublish(site.getId(), ids);
