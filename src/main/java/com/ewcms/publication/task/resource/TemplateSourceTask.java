...
public class TemplateSourceTask extends TemplateSourceSiteTask{
	...
	public TemplateSourceTask(Site site, String tempRoot, List<Long> ids, TemplateSourcePublishDaoable templateSourcePublishDao) {
		super(site, tempRoot, true, templateSourcePublishDao);
		this.ids = ids;
	}
	...
	protected int totalCount() {
		sources = templateSourcePublishDao.findPublish(site.getId(), ids);
		return sources.size();
	}
}
