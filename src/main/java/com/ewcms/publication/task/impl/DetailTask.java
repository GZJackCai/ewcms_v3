...
public class DetailTask extends TaskBase{
    ...
    public static class Builder extends BaseBuilder<Builder>{
        ...
        private List<Article> getArticleOfChannel(){
            return articlePublishService.findPublishArticles(channel.getId(), again, MAX_PUBLISH_SIZE);
        }
        ...
        protected List<TaskProcessable> getTaskProcesses() {
            ...
            for(Article article : articles){
                ...
                process.registerEvent(new DetailEvent(complete,articlePublishService,article));
