...
public class ResourceTask extends TaskBase{
    ...
    public static class Builder extends BaseBuilder<Builder>{
        ...
        public Builder(ResourcePublishService resourcePublishService,Site site){
            super(site);
        ...
        private List<Resource> getResourceOfSite(){
            return resourcePublishService.findPublishResources(site.getId(),again);
        }
        ...
        private List<Resource> getResourceOfPublishIds(){
            ...
            for(Long id : publishIds){
                Resource resource = resourcePublishService.getResource(id);
                if(resource != null){
        ...
        protected List<TaskProcessable> getTaskProcesses(){
            ...
            for(Resource resource : resources){
                ...
                process.registerEvent(new ResourceEvent(complete,resource,resourcePublishService));
