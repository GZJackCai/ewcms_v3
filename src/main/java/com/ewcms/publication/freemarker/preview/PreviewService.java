...
public class PreviewService implements PreviewServiceable ,MessageSourceAware{
     ...
     * 
     * @param articlePublishService 文章发布
     * @param mock 是否模拟
     * @return
     */
    Configuration getConfiguration(ArticlePublishService articlePublishService,boolean mock)throws PublishException{
        ...
        try{
            ...
            factory.setArticlePublishService(articlePublishService);
            factory.setChannelPublishService(channelPublishService);
            factory.setTemplatePublishService(templatePublishService);
    ...
    protected void viewHomeTemplate(
        ...
        ArticlePublishService service = new ArticlePublishServiceWrapper(articlePublishService,mock);
    ...
    public void viewArticle(OutputStream out,Long channelId,Long id, Integer pageNumber) throws PublishException {
        ...
        Article article = articlePublishService.getArticle(id);
        if(article == null){
        ...
        for(Template t : templatePublishService.getTemplatesInChannel(channelId)){
