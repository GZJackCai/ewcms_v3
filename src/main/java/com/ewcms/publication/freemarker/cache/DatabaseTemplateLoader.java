...
public class DatabaseTemplateLoader implements TemplateLoader{
    ...
    public DatabaseTemplateLoader(TemplatePublishService service){
        templatePublishService = service;
    }
    ...
    public Object findTemplateSource(String name) throws IOException {
        ...
        Template template = templatePublishService.getTemplateByUniquePath(path);
