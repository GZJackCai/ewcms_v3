...
<html>
  <head>
	...
	<script type="text/javascript" src="${ctx}/static/views/content/particular/approvalrecord/index.js"></script>
	<script type="text/javascript">
		var _approvalRecordIndex = new ApprovalRecordIndex('#tt');
		$(function(){
			_approvalRecordIndex.init({
		       	queryUrl : '${ctx}/content/particular/approvalrecord/query',
		       	editUrl : '${ctx}/content/particular/approvalrecord/edit',
		       	deleteUrl : '${ctx}/content/particular/approvalrecord/delete'
			});
		});
	</script>		
  </head>
      ...
      <div id="tb" style="padding:5px;height:auto;">
        ...
        <div  style="padding-left:5px;">
          <form id="queryform"  style="padding: 0;margin: 0;">
                     组织机构代码：<input type="text" name="LIKE_code" style="width:120px;"/>&nbsp;
                     机关单位名称：<input type="text" name="LIKE_name" style="width:120px;"/>&nbsp;
