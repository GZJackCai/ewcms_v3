	...
	<script type="text/javascript">
		$(function() {
			...
			$('#tt').datagrid({
				...
				striped : true,
				pageSize:30,
				url : '${ctx}/visit/loyalty/sticktime/table?startDate=' + $('#startDate').datebox('getValue') + '&endDate=' + $('#endDate').datebox('getValue'),
			    columns:[[  
			            {field:'visitDate',title:'日期',width:200},  
			            {field:'stickTimeSum',title:'会话停留时间(秒)',width:150},  
			            {field:'stickTimeAvg',title:'页均停留时间(秒)',width:150}
			    ]]  
			});
			showChart();
		});
		function showChart(){
			...
			$.post('${ctx}/visit/loyalty/sticktime/report', parameter, function(result) {
