...
<html>
  ...
  <body class="easyui-layout">
	...
	<div region="center">
	  <!-- 
	  <table class="easyui-datagrid" fit="true" border="false" data-options="singleSelect:true,pagination:true,nowrap:true,striped:true,rownumbers:true,fitColumns:true,pageSize:30,url:'${ctx}/visit/loyalty/back/table?startDate='" + $('#startDate').datebox('getValue')>
	    <thead>
	      <tr>
	        <th data-options="field:'visitDate',width:120">日期</th>
	        <th data-options="field:'newVisitor',width:100">新访客数量</th>
	        <th data-options="field:'backVisitor',width:100">回头客数量</th>
	        <th data-options="field:'rate',width:100">回头率</th>
	      </tr>
	    </thead>
	  </table>
	   -->
