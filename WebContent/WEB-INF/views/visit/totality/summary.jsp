  ...
  <body class="easyui-layout">
	...
	<script type="text/javascript">
		...
		$(function() {
			    ...
			    columns:[[  
				        ...
				        {field:'pageViewSum',title:'PV数量',width:120,
				            formatter : function(val, rec){
				            	...
				            	else return rec.pageViewBetide;
				            }
				        },  
				        {field:'uniqueIdCount',title:'UV数量',width:120,
				            formatter : function(val, rec){
				            	if (rec.name != '') return val;
				            	else return rec.uniqueIdBetide;
				            }
				        },
				        {field:'ipCount',title:'IP数量',width:120,
				            formatter : function(val, rec){
				            	if (rec.name != '') return val;
				            	else return rec.ipBetide;
				            }
				        },
				        {field:'rate',title:'回头率',width:120,
				            formatter : function(val, rec){
			...
			function showChart(){
				var parameter = {};
				parameter['startDate'] =  dateTimeToString(new Date(new Date() - 30*24*60*60*1000));
				parameter['endDate'] = dateTimeToString(new Date());
