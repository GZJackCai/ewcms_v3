	...
	<script type="text/javascript">
		$(function() {
			...
			$('#tt').datagrid({
				...
				fitColumns : true,
				pageSize:30,
				url : '${ctx}/visit/totality/entrance/table?startDate=' + $('#startDate').datebox('getValue') + '&endDate=' + $('#endDate').datebox('getValue'),
			    columns:[[  
		...
		function openTrend(value){
			var url = '${ctx}/visit/totality/entrance/trend/index/' + value + '?startDate=' + $('#startDate').datebox('getValue') + '&endDate=' + $('#endDate').datebox('getValue');
