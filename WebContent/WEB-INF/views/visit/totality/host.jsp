  ...
  <head>
	...
	<script type="text/javascript">
				    ...
				    columns:[[  
				            ...
				            {field:'trend',title:'时间趋势',width:70,
				            	formatter : function(val, rec){	
				            		return '<a href="javascript:void(0)" onclick="openTrend(\'' + rec.host + '\')" style="text-decoration: none">时间趋势</a>';
				            	}
				            }
				    ]]  
				});
			...
			function openTrend(value){
				var url = '${ctx}/visit/totality/host/trend/index/' + value + '?startDate=' + $('#startDate').datebox('getValue') + '&endDate=' + $('#endDate').datebox('getValue');
