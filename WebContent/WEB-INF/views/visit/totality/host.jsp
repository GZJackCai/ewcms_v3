	...
	<script type="text/javascript">
		$(function() {
			...
			$('#tt').datagrid({
				...
				striped : true,
				rownumbers : true,
				url : '${ctx}/visit/totality/host/table?startDate=' + $('#startDate').datebox('getValue') + '&endDate=' + $('#endDate').datebox('getValue'),
				columns:[[  
				        {field:'host',title:'名称',width:120,
				            formatter : function(val, rec){
				            	return rec.hostPk.hostName;
				            }	
				        },
				        {field:'hostCount',title:'PV数量',width:100},
				        {field:'rate',title:'比例',width:100},
				        {field:'trend',title:'时间趋势',width:70,
				            formatter : function(val, rec){	
				            	return '<a href="javascript:void(0)" onclick="openTrend(\'' + rec.hostPk.hostName + '\')" style="text-decoration: none">时间趋势</a>';
				            }
				        }
				    ]]  
				});
			...
			function openTrend(value){
				var url = '${ctx}/visit/totality/host/trend/index/?host=' + value + '&startDate=' + $('#startDate').datebox('getValue') + '&endDate=' + $('#endDate').datebox('getValue');
			...
			function showChart(){
				...
				$.post('${ctx}/visit/totality/host/report', parameter, function(result) {
