  ...
  <body class="easyui-layout">
	...
	<div region="north" style="height:310px" border="false">
	  <table width="100%" border="0" cellspacing="6" cellpadding="0" style="border-collapse: separate; border-spacing: 6px;">
		<tr>
		  <td>当前位置：<a href="${ctx}/visit/totality/region/country/index" style="text-decoration: none">全部</a> >> <font color="red">${country}(国家)</font></td>
		</tr>
		<tr>
	...
	<script type="text/javascript">
		$(function() {
			...
			$('#tt').datagrid({
				...
				nowrap : true,
				striped : true,
				url :  '${ctx}/visit/totality/region/province/table/${country}?startDate=' + $('#startDate').datebox('getValue') + '&endDate=' + $('#endDate').datebox('getValue'),
				columns:[[  
				        {field:'province',title:'省份',width:120,
				            formatter : function(val, rec){
				            	return '<a style="text-decoration: none" href="javascript:void(0);" onclick="openLevel(\'' + rec.regionPk.province + '\')">' + rec.regionPk.province + '</a>';
				            }
				        },
				        ...
				        {field:'trend',title:'时间趋势',width:70,
				           	formatter : function(val, rec){	
				            	return '<a style="text-decoration: none" href="javascript:void(0);" onclick="openTrend(\'' + rec.regionPk.province + '\')">时间趋势</a>';
				            }
				        }
				]]  
			});
		...
		function showChart(){
			...
			$.post('${ctx}/visit/totality/region/province/report/${country}', parameter, function(result) {
		...
		function openTrend(value){
			var url = '${ctx}/visit/totality/region/province/trend/index/${country}_' + value + '?startDate=' + $('#startDate').datebox('getValue') + '&endDate=' + $('#endDate').datebox('getValue');
		...
		function openLevel(name){
			window.location = '${ctx}/visit/totality/region/city/index/${country}_' + name + '?startDate=' + $('#startDate').datebox('getValue') + '&endDate=' + $('#endDate').datebox('getValue'); 
		}
	</script>
  </body>
</html>