  ...
  <body>
	...
	<form:form id="inputForm" action="${ctx}/scheduling/job/channel/save" method="post" modelAttribute="pageDisplay" class="form-horizontal">
	  ...
	  <table class="formtable" align="center">
		...
		<tr>
		  <td width="10%">频道名称：</td>
		  <td width="40%"><input type="text" id="label" name="label" maxlength="50" readonly="readonly" value="${pageDisplay.label}"/></td>
		  <td width="10%">&nbsp;</td>
		  <td width="40%"><form:checkbox path="subChannel" label="应用于子频道" cssStyle="vertical-align: middle;"/></td>
		</tr>
		<tr>
		  <td width="10%">说明：</td>
