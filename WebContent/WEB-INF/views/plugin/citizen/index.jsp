...
<html>
  <head>
	...
	<script type="text/javascript" src="${ctx}/static/views/plugin/citizen/index.js"></script>
	<script type="text/javascript">
		var _citizenIndex = new CitizenIndex('#tt');
		$(function(){
			_citizenIndex.init({
				queryUrl : '${ctx}/plugin/citizen/query',
				editUrl : '${ctx}/plugin/citizen/edit',
				deleteUrl : '${ctx}/plugin/citizen/delete'
			});
		});
		</script>		
	</head>
