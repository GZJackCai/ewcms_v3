	...
	<div data-options="region:'center',split:true" style="padding:2px;" border="false">
      ...
      <div id="tb" style="padding:5px;height:auto;">
        <div class="toolbar" style="margin-bottom:2px">
		  <a id="tb-add" href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add',toggle:true">添加</a>
 		  <a id="tb-remove" href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove',toggle:true">移除</a>
		</div>
