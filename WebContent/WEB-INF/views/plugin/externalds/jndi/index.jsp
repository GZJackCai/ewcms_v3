...
<html>
  <head>
	...
	<script type="text/javascript" src="${ctx}/static/views/plugin/externalds/jndi/index.js"></script>
	<script type="text/javascript">
		var _jndiDsIndex = new JndiDsIndex("#tt");
		$(function(){
			_jndiDsIndex.init({
				queryUrl : '${ctx}/plugin/externalds/jndi/query',
				editUrl : '${ctx}/plugin/externalds/jndi/edit',
				deleteUrl : '${ctx}/plugin/externalds/jndi/delete',
      ...
      <div id="tb" style="padding:5px;height:auto;">
        ...
        <div  style="padding-left:5px;">
          <form id="queryform"  style="padding: 0;margin: 0;">
            ...
            Jndi名称：<input type="text" name="LIKE_jndiName" style="width:120px;"/>&nbsp;
            Jndi方法：<input type="text" name="LIKE_jndiMethod" style="width:120px;"/>
