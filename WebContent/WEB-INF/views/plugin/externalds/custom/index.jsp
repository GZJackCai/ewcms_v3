...
<html>
  <head>
	...
	<script type="text/javascript" src="${ctx}/static/views/plugin/externalds/custom/index.js"></script>
	<script type="text/javascript">
		var _customDsIndex = new CustomDsIndex("#tt");
		$(function(){
			_customDsIndex.init({
				queryUrl : '${ctx}/plugin/externalds/custom/query',
				editUrl : '${ctx}/plugin/externalds/custom/edit',
				deleteUrl : '${ctx}/plugin/externalds/custom/delete',
				isConnectUrl : '${ctx}/plugin/externalds/isConnect'
			});
		});
	</script>		
  </head>
      ...
      <div id="tb" style="padding:5px;height:auto;">
        ...
        <div  style="padding-left:5px;">
          <form id="queryform"  style="padding: 0;margin: 0;">
                      ...
                      自定义名称：<input type="text" name="LIKE_customName" style="width:120px;"/>&nbsp;
                      自定义方法：<input type="text" name="LIKE_customMethod" style="width:120px;"/>
                      说明：<input type="text" name="LIKE_remarks" style="width:120px"/>&nbsp;
