...
<html>
  <head>
	...
	<script type="text/javascript" src="${ctx}/static/views/plugin/externalds/bean/index.js"></script>
	<script type="text/javascript">
		var _beanDsIndex = new BeanDsIndex("#tt");
		$(function(){
			_beanDsIndex.init({
				queryUrl : '${ctx}/plugin/externalds/bean/query',
				editUrl : '${ctx}/plugin/externalds/bean/edit',
				deleteUrl : '${ctx}/plugin/externalds/bean/delete',
      ...
      <div id="tb" style="padding:5px;height:auto;">
        ...
        <div  style="padding-left:5px;">
          <form id="queryform"  style="padding: 0;margin: 0;">
            ...
            Bean名称：<input type="text" name="LIKE_beanName" style="width:120px;"/>&nbsp;
            Bean方法：<input type="text" name="LIKE_beanMethod" style="width:120px;"/>
