...
<html>
  <head>
	...
	<script type="text/javascript" src="${ctx}/static/views/plugin/externalds/jdbc/index.js"></script>
	<script type="text/javascript">
		var _jdbcDsIndex = new JdbcDsIndex("#tt");
		$(function(){
			_jdbcDsIndex.init({
				queryUrl : '${ctx}/plugin/externalds/jdbc/query',
				editUrl : '${ctx}/plugin/externalds/jdbc/edit',
				deleteUrl : '${ctx}/plugin/externalds/jdbc/delete',
      ...
      <div id="tb" style="padding:5px;height:auto;">
        ...
        <div  style="padding-left:5px;">
          <form id="queryform"  style="padding: 0;margin: 0;">
                      ...
                      驱动名：<input type="text" name="LIKE_driver" style="width:120px;"/>
